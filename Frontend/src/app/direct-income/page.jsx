...
import { FaCoins, FaSpinner, FaChevronLeft, FaChevronRight, FaCalendar } from 'react-icons/fa'
...
export default function DirectIncomePage() {
  ...
  const fetchDirectIncome = async () => {
    try {
      ...
      toast.error('Failed to load direct income transactions')
    } finally {
      setLoading(false)
    }
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">You need to login to view your direct income</p>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Track all your direct referral earnings
          </p>
        </div>
        ...
        <div className="gradient-card mb-8">
          <div className="gradient-card-inner p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-400 text-sm mb-1">Total Direct Income</p>
          ...
          <div className="gradient-card-inner p-6">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 text-lg">No direct income transactions yet</p>
                <p className="text-gray-500 text-sm mt-2">
                  Earn direct income by referring new members
                </p>
              </div>
            ) : (
              <>
