...
import { FaSwimmingPool, FaSpinner, FaChevronLeft, FaChevronRight, FaCalendar } from 'react-icons/fa'
import toast from 'react-hot-toast'

export default function PoolIncomePage() {
  ...
  const fetchPoolIncome = async () => {
    try {
      ...
      console.error('Error fetching pool income:', error)
      toast.error('Failed to load pool income transactions')
    } finally {
      setLoading(false)
    }
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">You need to login to view your pool income</p>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Passive earnings from the global auto pool distribution
          </p>
        </div>
        ...
        <div className="gradient-card mb-8">
          <div className="gradient-card-inner p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-400 text-sm mb-1">Total Pool Income</p>
                <h2 className="text-3xl font-bold text-white flex items-center">
                  <FaSwimmingPool className="text-cyan-400 mr-3" />
          ...
          <div className="gradient-card-inner p-6">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                <FaSwimmingPool className="text-6xl text-gray-600 mx-auto mb-4" />
                <p className="text-gray-400 text-lg">No pool income transactions yet</p>
                <p className="text-gray-500 text-sm mt-2">
                  Pool income is distributed automatically from the global pool
                </p>
              </div>
            ) : (
              <>
