...
// Helper function to generate tree positions
const generateTreeLayout = (
  ...
  // Add left child
  if (data.left) {
    const leftResult = generateTreeLayout(
      data.left,
      x - spacing,
      y + verticalSpacing,
      level + 1,
  ...
  // Add right child
  if (data.right) {
    const rightResult = generateTreeLayout(
      data.right,
      x + spacing,
      y + verticalSpacing,
      level + 1,
...
export default function BinaryTree({ treeData = sampleTreeData, height = '800px' }: BinaryTreeProps) {
  const { nodes: initialNodes, edges: initialEdges } = useMemo(
    () => generateTreeLayout(treeData, 400, 50, 0, 200, 220),
    [treeData]
  )
              ...
              <div className="flex flex-wrap gap-4 text-sm">
                <div className="flex items-center space-x-2">
                  <svg width="30" height="12" viewBox="0 0 30 12">
                    ...
                    <line x1="0" y1="6" x2="30" y2="6" stroke="#10b981" strokeWidth="2" markerEnd="url(#arrow-green)" />
                  </svg>
                ...
                <div className="flex items-center space-x-2">
                  <svg width="30" height="12" viewBox="0 0 30 12">
                    ...
                    <line x1="0" y1="6" x2="30" y2="6" stroke="#3b82f6" strokeWidth="2" markerEnd="url(#arrow-blue)" />
                  </svg>
                ...
                <div className="flex items-center space-x-2">
                  <svg width="30" height="12" viewBox="0 0 30 12">
                    ...
                    <line x1="0" y1="6" x2="30" y2="6" stroke="#6b7280" strokeWidth="2" strokeDasharray="5,5" markerEnd="url(#arrow-gray)" />
                  </svg>
